...
<body>
  ...
  <div id="container1">
    ...
    <div id='textbox' class="rectangle">
      <span id="displayText">Set the normality of titrate(Sulphuric Acid) and volume of titrant(Sample water solution) according to you, click start button.</span>
  ...
  <script>
    const textArray = ["Set the normality of titrate(Sulphuric Acid) and volume of titrant(Sample water solution) according to you, click start button.", "Fix the nozzle opening size by nozzle open slider.Shake the flask while Titrating.", "Titrate the solution till it turn to transparent.",""]; // Add more texts as needed
    let currentIndex = 0;
