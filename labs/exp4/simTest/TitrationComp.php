...
$data2 = $_SESSION['volume_titrant'];
$data3 = $_SESSION['Vadded'];
$data4 = $_SESSION['Result1'];
$data5 = $_SESSION['Normality_titrate2'];
$data6 = $_SESSION['volume_titrant2'];//initial vol of soln in 2nd titration
$data7=$_SESSION['volume_titrate2']; //used sulphuric acid
$data8 = $_SESSION['Normality_titrant2'];
