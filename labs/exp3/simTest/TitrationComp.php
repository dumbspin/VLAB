...
<div style="text-align: center;">
    ...
    <h2>To determine the hardness of water sample before and after passing the water sample from ion-exchange coloumn.</h2>
    <h3>Results</h3>
  ...
  <table>
    ...
    <tbody>
      <tr>
        <td>Before passing the ion-exchange coloumn(B)</td>
